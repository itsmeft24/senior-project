...
BUILD		:=	build
SOURCES		:=	source source/ntr source/ntr/gfx/backend_temp source/ntr/logic
DATA		:=
TEXTURES	:=	textures 
INCLUDES	:=
...
#---------------------------------------------------------------------------------
LIBS	:= -lgrrlib -lpngu `$(PREFIX)pkg-config freetype2 libpng libjpeg --libs` -lfat -laesnd
LIBS	+= -lwiiuse
LIBS	+= -lbte -logc -lm
